...
namespace TastyRestaurant.Api
{
    ...
    {
        private readonly IConfiguration _congiruation;

        public Startup(IConfiguration congiruation)
        {
            _congiruation = congiruation;
        }
...
#endif
            var connectionString = _congiruation["connectionStrings:cityInfoDBConnectionString"];
